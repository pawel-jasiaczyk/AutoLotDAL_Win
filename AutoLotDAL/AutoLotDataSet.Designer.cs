...
SELECT CustID, FirstName, LastName FROM Customers WHERE (CustID = @CustID)";
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Inventory] WHERE (([CarID] = @Original_CarID) AND ((@IsNull_Ma" +
                "ke = 1 AND [Make] IS NULL) OR ([Make] = @Original_Make)) AND ((@IsNull_Color = 1" +
                " AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([PetName] = @Original" +
                "_PetName))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Inventory] SET [CarID] = @CarID, [Make] = @Make, [Color] = @Color, [PetName] = @PetName WHERE (([CarID] = @Original_CarID) AND ((@IsNull_Make = 1 AND [Make] IS NULL) OR ([Make] = @Original_Make)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([PetName] = @Original_PetName));
SELECT CarID, Make, Color, PetName FROM Inventory WHERE (CarID = @CarID)";
        ...
        public virtual int Delete(int Original_CarID, string Original_Make, string Original_Color, string Original_PetName) {
            ...
            if ((Original_PetName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_PetName));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
